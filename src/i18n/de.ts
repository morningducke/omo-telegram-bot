...
export const de: I18nDictionary = {
  ...
  "cmd.description.replies": "Browse assistant replies",
  "cmd.description.dialogue": "Start CLI dialogue mode",
  "cmd.description.end": "Exit dialogue mode",
  "dialogue.header": "💬 Dialogue mode — type to chat, /end to exit",
  "dialogue.continuation": "💬 Dialogue (continued)",
  "dialogue.started_hint": "Type a message below to chat. It will be appended to a growing transcript with the agent's streamed replies.",
  "dialogue.already_active": "Dialogue mode is already active.",
  "dialogue.not_active": "Dialogue mode is not active.",
  "dialogue.ended": "Dialogue mode ended.",
  "replies.select": "Choose a reply:",
  "replies.select_page": "Choose a reply (page {page}):",
  "replies.empty": "📭 No assistant replies in the current session.",
  "replies.button.prev_page": "⬅️ Prev",
  "replies.button.next_page": "Next ➡️",
  "replies.button.back": "⬅️ Back",
  "replies.button.cancel": "❌ Cancel",
  ...
  "runtime.wizard.tty_required":
    "Der interaktive Assistent erfordert ein TTY-Terminal. Führe `omo-telegram config` in einer interaktiven Shell aus.",
