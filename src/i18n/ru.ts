...
export const ru: I18nDictionary = {
  ...
  "cmd.description.replies": "Ответы ассистента",
  "cmd.description.dialogue": "Режим CLI-диалога",
  "cmd.description.end": "Выйти из диалога",
  "dialogue.header": "💬 Режим диалога — пишите сообщения, /end для выхода",
  "dialogue.continuation": "💬 Диалог (продолжение)",
  "dialogue.started_hint": "Напишите сообщение ниже. Оно будет добавлено в растущий транскрипт вместе с ответами агента.",
  "dialogue.already_active": "Режим диалога уже активен.",
  "dialogue.not_active": "Режим диалога не активен.",
  "dialogue.ended": "Режим диалога завершён.",
  "replies.select": "Выберите ответ:",
  "replies.select_page": "Выберите ответ (страница {page}):",
  "replies.empty": "📭 В текущей сессии нет ответов ассистента.",
  "replies.button.prev_page": "⬅️ Назад",
  "replies.button.next_page": "Вперёд ➡️",
  "replies.button.back": "⬅️ К списку",
  "replies.button.cancel": "❌ Отмена",
  ...
  "runtime.wizard.tty_required":
    "Интерактивный wizard требует TTY-терминал. Запустите `omo-telegram config` в интерактивной оболочке.",
